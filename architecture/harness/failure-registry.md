...
|---|---|---|---|---:|---|---|---|---|---|---|---|---|---|---|---|---|
| `FR-001` | method-health | method-health-gap | portable-method | 1 | The method described a failure registry but had no repo-local registry file or dedicated checker. | Repeated failures could be discussed without becoming durable guide, sensor, gate, or template changes. | method-gate | `agentic-method-kit/HARNESS_COVERAGE_MODEL.md` | `scripts/harness/check-failure-registry.mjs` | `scripts/harness/check-method-health.mjs --strict` | harness method review | previous method-health check | sensor | sensor-added | none | implemented |
...
| `FR-003` | method-health | method-health-gap | portable-method | 1 | The required Harness workflow assumed a parent workspace path and strict evidence/review checks passed with zero artifacts. | A standalone method checkout could fail CI paths or report a false green lifecycle gate. | method-gate | `agentic-method-kit/INSTALL.md` | `scripts/harness/check-evidence.mjs`, `scripts/harness/check-review.mjs` | `Harness report` | team-mode governance review | previous workflow path checks | gate | gate-updated | none | implemented |
