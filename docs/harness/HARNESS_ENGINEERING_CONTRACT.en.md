...
3. the task packet or minimum plan has been executed
4. verification commands matching the change surface have been run
5. verification evidence has been saved or summarized
6. if contracts, interfaces, menus, permissions, i18n, database, or acceptance semantics were touched, docs have been synchronized
7. if UI was touched, the visual quality gate has been run and screenshots, browser evidence, or a recorded reason for not running have been saved
8. unverified items and residual risk have been listed
9. the review gate has no unresolved P0/P1 findings
10. if document governance is enabled in the repository, the frontmatter / README / contract linkage checks defined by `DOCUMENT_FRONTMATTER_SPEC.md` must also pass
