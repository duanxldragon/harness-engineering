...
This document explains how Pantheon supports multiple agent tools without becoming locked into any one tool.
...
`HARNESS_METHOD_PLAYBOOK.md` answers “what should happen first, what next, and what each tool is responsible for.” The other contracts define boundaries, formats, and gates.
